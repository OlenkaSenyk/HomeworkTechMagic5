...
const getAllDataBtn = document.getElementById("get-all-data-btn");
const closeAllDataBtn = document.getElementById("close-all-data-btn");
const updateObjBtn = document.getElementById("update-object-btn");
const task1Title = document.getElementById("table1-title");
const task2TitleBefore = document.getElementsByClassName("table2-title")[0];
const task2TitleAfter = document.getElementsByClassName("table2-title")[1];
const task1Table = document.getElementById("task1-table");
const task2Tables = document.getElementById("task2-tables");
